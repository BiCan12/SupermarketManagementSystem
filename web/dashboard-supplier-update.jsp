        ...
        <div class="container-fluid" style="width: 90%;margin: 0 auto;padding: 5px 0;">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" style="margin-top: 5px;">
                    <li><a href="dashboard.jsp" style="font-size: 20px">丿记忆灬永殇丨超市管理系统<span
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="dashboard-employee-update.jsp">修改员工信息</a></li>
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="dashboard-supplier-update.jsp">修改供应商信息</a></li>
        ...
        <div class="col-md-9">
            <div style="margin-top: 20px">
                <div style="padding-bottom: 10px;border-bottom: 1px solid #0f88eb;">
                    <form class="form-inline" method="post" action="getUpdateSupplier.action">
                        <div class="form-group" style="margin-right: 30px">
                            <label for="fid" style="margin-right: 10px">供应商编号</label>
                            <input type="number" name="fid" id="fid" class="form-control" placeholder="请输入要修改的供应商编号"
                                   style="width: 485px" value="<s:property value="findSupplier.sid"/>">
                        </div>
                ...
                <div style="margin-top: 10px">
                    <form method="post" role="form" action="updateSupplier.action">
                        <div class="form-group">
                            <label for="sid">编号</label>
                            <input type="number" name="sid" id="sid" class="form-control"
                                   value="<s:property value="findSupplier.sid"/>">
                        </div>
                        <div class="form-group">
                            <label for="name">名称</label>
                            <input type="text" name="name" id="name" class="form-control"
                                   value="<s:property value="findSupplier.name"/>">
                        </div>
                        <div class="form-group">
                            <label for="goods">商品类型</label>
                            <input type="text" name="goods" id="goods" class="form-control"
                                   value="<s:property value="findSupplier.goods"/>">
                        </div>
                        <div class="form-group">
                            <label for="phone">联系电话</label>
                            <input type="text" name="phone" id="phone" class="form-control"
                                   value="<s:property value="findSupplier.phone"/>">
                        </div>
                        <button type="submit" class="btn btn-warning" style="width: 40%;float:left;margin: 0 5%;">更新
                        </button>
