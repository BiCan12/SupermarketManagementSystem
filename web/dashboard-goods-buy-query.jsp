                    ...
                    <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="dashboard-goods-buy-query.jsp">查询进货信息</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-9">
            <div style="margin-top: 20px">
                <div style="padding-bottom: 10px;border-bottom: 1px solid #0f88eb;">
                    <form class="form-inline" method="post" action="findBuyGoods.action">
                        ...
                        <a href="findAllBuyGoods.action" class="btn btn-primary"
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <s:iterator value="goodsList" var="goods">
                            <tr>
                                ...
                                <td><s:property value="#goods.cost"/></td>
                                <td><s:property value="#goods.buy"/></td>
                            </tr>
                        </s:iterator>
                    </table>
                </div>
