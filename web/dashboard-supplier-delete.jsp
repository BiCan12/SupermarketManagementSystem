                    ...
                    <div id="collapseTwo" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="dashboard-supplier-delete.jsp">删除供应商信息</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-9">
            <div style="margin-top: 20px">
                <div style="padding-bottom: 10px;border-bottom: 1px solid #0f88eb;">
                    <form class="form-inline" method="post" action="getDeleteSupplier.action">
                        <div class="form-group" style="margin-right: 30px">
                            <label for="fid" style="margin-right: 10px">供应商编号</label>
                            <input type="number" name="fid" id="fid" class="form-control" placeholder="请输入要删除的供应商编号"
                ...
                <div style="margin-top: 10px">
                    <form method="post" role="form" action="deleteSupplier.action">
