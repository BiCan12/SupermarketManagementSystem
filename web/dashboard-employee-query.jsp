        ...
        <div class="col-md-9">
            <div style="margin-top: 20px">
                <div style="padding-bottom: 10px;border-bottom: 1px solid #0f88eb;">
                    <form class="form-inline" method="post" action="findEmployee.action">
                        <div class="form-group" style="margin-right: 30px">
                            <label for="sid" style="margin-right: 10px">员工工号</label>
                            <input type="number" name="sid" id="sid" class="form-control" placeholder="请输入要查询的员工工号"
                        ...
                        <a href="findAllEmployee.action" class="btn btn-primary"
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <s:iterator value="employeeList" var="employee">
                            <tr>
                                ...
                                <td><s:property value="#employee.password"/></td>
