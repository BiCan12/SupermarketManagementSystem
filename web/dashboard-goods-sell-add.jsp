            ...
            <div class="panel-group" id="accordion">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="dashboard-goods-buy-add.jsp">添加进货信息</a></li>
                ...
                <div class="panel panel-primary" style="margin-top: 20px">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="dashboard-goods-sell-add.jsp">添加销售信息</a></li>
        ...
        <div class="col-md-9">
            <div style="margin-top: 20px">
                <div style="padding-bottom: 10px;border-bottom: 1px solid #0f88eb;">
                    <form class="form-inline" method="post" action="getSellGoods.action">
                        <div class="form-group" style="margin-right: 30px">
                            <label for="sid" style="margin-right: 10px">商品编号</label>
                            <input type="number" name="sid" id="sid" class="form-control" placeholder="请输入要添加销量的商品编号"
                                   style="width: 500px" value="<s:property value="searchGoods.gid"/>">
                        </div>
                ...
                <div style="margin-top: 10px">
                    <form method="post" role="form" action="addGoodsSell.action">
                        <div class="form-group">
                            <label for="gid">商品编号</label>
                            <input type="number" name="gid" id="gid" class="form-control"
                                   value="<s:property value="searchGoods.gid"/>">
                        </div>
                        <div class="form-group">
                            <label for="name">商品名称</label>
                            <input type="text" name="name" id="name" class="form-control"
                                   value="<s:property value="searchGoods.name"/>">
                        </div>
                        <div class="form-group">
                            <label for="type">商品类型</label>
                            <input type="text" name="type" id="type" class="form-control"
                                   value="<s:property value="searchGoods.type"/>">
                        </div>
                        <div class="form-group" style="display: none;">
                            <label for="cost">商品进价</label>
                            <input type="number" name="cost" id="cost" class="form-control"
                                   value="<s:property value="searchGoods.cost"/>">
                        </div>
                        <div class="form-group" style="display:none;">
                            <label for="buy">进货数量</label>
                            <input type="number" name="buy" id="buy" class="form-control"
                                   value="<s:property value="searchGoods.buy"/>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="sell">销量</label>
                            <input type="number" name="sell" id="sell" class="form-control">
                        </div>
                        <button type="submit" class="btn btn-warning" style="width: 40%;float:left;margin: 0 5%;">添加
                        </button>
