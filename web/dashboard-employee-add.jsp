    ...
    <div class="container" style="width: 90%;margin-top: 80px;min-height: 600px;background: rgba(255, 255, 255, .5);">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="dashboard-employee-add.jsp">添加员工信息</a></li>
        ...
        <div class="col-md-9">
            <div style="margin-top: 20px">
                <form method="post" role="form" action="addEmployee.action">
                    <div class="form-group">
                        <label for="eid">工号</label>
                        <input type="number" name="eid" id="eid" class="form-control" placeholder="请输入工号">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="phone" id="phone" class="form-control" placeholder="请输入手机号码"
                               maxlength="11">
                    </div>
                    <div class="form-group">
