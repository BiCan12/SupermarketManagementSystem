            ...
            <div class="panel-group" id="accordion">
                ...
                <div class="panel panel-primary" style="margin-top: 20px">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="dashboard-goods-remain-query.jsp">查询库存信息</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-9">
            <div style="margin-top: 20px">
                <div style="padding-bottom: 10px;border-bottom: 1px solid #0f88eb;">
                    <form class="form-inline" method="post" action="findRemainGoods.action">
                        <div class="form-group" style="margin-right: 30px">
                            <label for="sid" style="margin-right: 10px">商品编号</label>
                            <input type="number" name="sid" id="sid" class="form-control" placeholder="请输入要查询的商品编号"
                        ...
                        <a href="findAllRemainGoods.action" class="btn btn-primary"
                ...
                <div>
                    <table class="table table-hover table-bordered">
                        ...
                        <s:iterator value="goodsList" var="goods">
                            <tr>
                                <td><s:property value="#goods.gid"/></td>
                                <td><s:property value="#goods.name"/></td>
                                <td><s:property value="#goods.type"/></td>
                                <td><s:property value="#goods.buy - #goods.sell"/></td>
                                <td style="color: #d9534f;">
                                    <s:if test="(#goods.buy - #goods.sell) < 10">
                                        该商品库存不足
                                    </s:if>
                                </td>
                            </tr>
