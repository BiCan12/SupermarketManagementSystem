                    ...
                    <div id="collapseTwo" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="dashboard-goods-sell-query.jsp">查询销售信息</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-9">
            <div style="margin-top: 20px">
                <div style="padding-bottom: 10px;border-bottom: 1px solid #0f88eb;">
                    <form class="form-inline" method="post" action="findSellGoods.action">
                        ...
                        <a href="findAllSellGoods.action" class="btn btn-primary"
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <s:iterator value="goodsList" var="goods">
                            <tr>
                                ...
                                <td><s:property value="#goods.sell"/></td>
                                <td><s:property value="#goods.price * #goods.sell"/></td>
                            </tr>
                        </s:iterator>
                    </table>
                </div>
