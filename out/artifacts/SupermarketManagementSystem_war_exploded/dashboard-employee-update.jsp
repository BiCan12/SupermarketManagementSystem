        ...
        <div class="col-md-9">
            <div style="margin-top: 20px">
                <div style="padding-bottom: 10px;border-bottom: 1px solid #0f88eb;">
                    <form class="form-inline" method="post" action="getUpdateEmployee.action">
                        <div class="form-group" style="margin-right: 30px">
                            <label for="sid" style="margin-right: 10px">员工工号</label>
                            <input type="number" name="sid" id="sid" class="form-control" placeholder="请输入要修改的员工工号"
                ...
                <div style="margin-top: 10px">
                    <form method="post" role="form" action="updateEmployee.action">
