    ...
    <div class="container" style="width: 90%;margin-top: 80px;min-height: 600px;background: rgba(255, 255, 255, .5);">
            ...
            <div class="panel-group" id="accordion">
                ...
                <div class="panel panel-primary" style="margin-top: 20px">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="dashboard-supplier-add.jsp">添加供应商信息</a></li>
        ...
        <div class="col-md-9">
            <div style="margin-top: 20px">
                <form method="post" role="form" action="addSupplier.action">
                    <div class="form-group">
                        <label for="sid">编号</label>
                        <input type="number" name="sid" id="sid" class="form-control" placeholder="请输入编号">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="goods" id="goods" class="form-control" placeholder="请输入商品类型">
                    </div>
                    <div class="form-group">
